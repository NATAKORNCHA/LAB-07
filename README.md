...
First-name | ใช้ไม่ได้|	เนื่องจากมีเครื่องหมายคณิตศาสตรอยู่ในชื่อ		
Hello!	| ใช้ไม่ได้ | มีตัวแปรที่ประกอบด้วยอักษรพิเศษ	
w*h 	| ใช้ไม่ได้ | มีตัวแปรที่ประกอบด้วยอักษรพิเศษ				
...
21November	| ใช้ไม่ได้ | ตัวแปรจะไม่ต้องขึ้นต้นด้วยเลข			
ladkrabang	|ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ		
Student ID	| ใช้ไม่ได้ |	ไม่สามาถเว้นวรรคในชื่อตัวแปรได้		
